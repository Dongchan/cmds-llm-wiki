...
별도의 mothership Obsidian 볼트를 운영하고 있다면 (예: 개인 PKM 볼트), 그 시스템 파일들을 Core Context 의 "동적 참조" 섹션에 등록한다. mothership pattern 예시는 [cmds-system-files](https://github.com/{your-github-handle}/cmds-system-files) 참고.
